...
dataPreprocesor = DataPreprocesor(historicData.city_historic_days, year_flights, historicData.get_city_list(), get_cities_prices(historicData.get_city_list()),NUMBER_OF_YEARS)
